    ...
    <div className="space-y-8">
      ...
      {!isLoading && certificates.length === 0 ? (
        <section className="rounded-[2rem] border border-dashed border-slate-300 bg-white p-8 text-center shadow-sm">
          ...
          <Link
            to="/certificate-policy"
            className="ml-0 mt-3 inline-flex items-center justify-center rounded-2xl border border-slate-300 px-5 py-3 text-sm font-bold text-slate-900 transition hover:border-slate-950 sm:ml-3"
          >
            Certificate policy
          </Link>
        </section>
